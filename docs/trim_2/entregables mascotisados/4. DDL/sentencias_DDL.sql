...
ALTER TABLE DETALLE_VENTA DROP CONSTRAINT  fk_detalle_compra_pedido1;
ALTER TABLE DETALLE_VENTA DROP CONSTRAINT  fk_detalle_compra_producto1;
ALTER TABLE LISTA_COMPRAS DROP CONSTRAINT fk_lista_compras_productos1;
ALTER TABLE LISTA_COMPRAS DROP CONSTRAINT fk_lista_compras_COMPRAS1;
...
ALTER TABLE PEDIDOS DROP CONSTRAINT fk_pedido_metodo_pago;
...
ALTER TABLE PEDIDOS DROP INDEX ind_pedido_cliente;
ALTER TABLE PEDIDOS DROP INDEX ind_pedido_metodo_pago;
ALTER TABLE PRODUCTOS DROP INDEX ind_producto_marca_producto;
ALTER TABLE PRODUCTOS DROP INDEX ind_producto_categoria;
ALTER TABLE DETALLE_VENTA DROP INDEX ind_detalle_compra_pedido;
ALTER TABLE DETALLE_VENTA DROP INDEX fk_detalle_compra_producto;
ALTER TABLE LISTA_COMPRAS DROP INDEX fk_lista_compras_productos1_idx;
ALTER TABLE LISTA_COMPRAS DROP INDEX fk_lista_compras_COMPRAS1_idx;
...
CREATE TABLE COMPRAS  (
   ...
   id_compras  DATE NOT NULL,
   documento  INT NOT NULL,
   total__a_pagar  INT NOT NULL,
...
CREATE TABLE lista_compras  (
  ...
  INDEX  fk_lista_compras_productos1_idx  ( productos_id_producto),
  INDEX  fk_lista_compras_COMPRAS1_idx  ( codigo_compra),
  CONSTRAINT  fk_lista_compras_productos1 
    FOREIGN KEY ( productos_id_producto )
    REFERENCES productos  ( id_producto )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT  fk_lista_compras_COMPRAS1 
...
CREATE INDEX  ind_pedido_metodo_pago  ON PEDIDOS (codigo_estado);
...
CREATE INDEX fk_lista_compras_productos1_idx ON LISTA_COMPRAS (productos_id_producto);
